...
export const publicationSchema = z.object({
  ...
  totalSurface: z.number().min(1, "La superficie total es requerida").optional(),
  coveredSurface: z.number().min(1, "La superficie cubierta es requerida").optional(),
  rooms: z.number().min(1, "El número de ambientes es requerido").optional(),
  bedrooms: z.number().min(0, "El número de dormitorios debe ser válido").optional(),
  bathrooms: z.number().min(1, "Al menos un baño es requerido").optional(),
  parkingSpaces: z.number().min(0, "El número de cocheras debe ser válido").optional(),
